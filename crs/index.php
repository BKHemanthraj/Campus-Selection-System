      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">     
          ...
          if(isset($_SESSION['id_user']) && empty($_SESSION['companyLogged'])) {
            ...
            <?php } else { 
            ?>
            <li style="padding-right: 25px;"><a href="mainregister.php" style="font-size: 30px; color: #053a5a; line-height: 42px;">Register</a></li>
            <li style="padding-right: -25px;"><a href="mainlogin.php" style="font-size: 30px; color: #053a5a; line-height: 42px;">Login</a></li>
          <?php } ?>
          </ul>
        </div>
      </div>
...
<br>
  ...
  <div align="center">
    ...
    <form action ="" method = "post">
      ...
      <input style="font-size: 18px; color: black; padding: 7px; border: 1px solid black; border-radius: 5px;" name="search" type="text" size="30" placeholder="Search By Job Title"/>
  ...
  <footer id="footer" style="background-color:black ; height: 80px;">
...
<div class="messaging-chat">
 ...
 <div align="right" style="background-color: black ; margin-top: -1.4%; height:400px;">
  <br>
      <p><img src="img/ewit1.png" align="left"></p>
      <a href="index.php" style="color:white;">EWIT </a>
      <a href="https://www.facebook.com/www.ewit.edu/" target="_blank"><img src="img/facebook.png" style="width: 30px; height: 30px; margin-left: 5px; margin-right: 5px;" /></a>
      <a href="https://www.instagram.com/ewit_official/" target="_blank"><img src="img/inst.png" style="width: 30px; height: 30px; margin-left: 5px; margin-right: 5px;" /></a>
